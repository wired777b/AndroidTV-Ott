...
public class WheelView extends ViewGroup {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			//中间的颜色
			centerDrawable = getContext().getResources().getDrawable(R.drawable.checked);
		...
		setBackgroundResource(R.drawable.city_bg);
	}
	...
	{
		return this.getViewAdapter().getItem(this.getCurrentItem(), null, this);
	}*/
	/**
	 * 设置背景颜色
	 */
	public void setBackground(View view)
	{
		...
		//this.getViewAdapter().getItem(this.getCurrentItem(), null, this).draw(canvas);
		//canvas.restore();
